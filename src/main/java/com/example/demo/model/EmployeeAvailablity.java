...
public class EmployeeAvailability {
    ...
    @NotNull @ManyToOne(fetch = FetchType.LAZY) @JoinColumn(name="employee_id")
    ...
    public EmployeeAvailability(Employee employee, LocalDate availableDate, Boolean available){this.employee=employee;this.availableDate=availableDate;this.available=available;}
